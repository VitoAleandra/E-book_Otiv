	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="/register/auth" method="post" class="login100-form validate-form">
					@csrf
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "No Hp Harus Diisi">
						<input class="input100" type="number" name="email" placeholder="No Hp">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
					</div>
                    <div class="wrap-input100 validate-input" data-validate = "Asal Kota Harus Diisi">
						<input class="input100" type="text" name="askot" placeholder="Asal kota">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
